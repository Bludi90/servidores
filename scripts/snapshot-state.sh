...
find_wg_list_peers() {
  for c in wg-list-peers /usr/local/bin/wg-list-peers /usr/sbin/wg-list-peers \
           /home/alejandro/servidores/scripts/wg-list-peers /home/alejandro/bin/wg-list-peers; do
    [ -x "$c" ] && { echo "$c"; return; }
